namespace DevTeam.Patterns.IoC.Tests
{
    ...
    public class AnyStateTypeAndKeyRegistrationComparerTests
    {
        [Test]
        public void ShouldReturnValidKey()
        {
            ...
            // Then
            target.Key.ShouldBe(WellknownRegistrationComparer.AnyStateTypeAndKey);
        }
        ...
        [TestCase(typeof(long), typeof(string), "abc", typeof(int), typeof(string), "abc", true)]
        ...
        {
            return new AnyStateTypeAndKeyRegistrationComparer();
        }
    }
}
