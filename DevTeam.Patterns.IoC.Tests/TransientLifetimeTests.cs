namespace DevTeam.Patterns.IoC.Tests
{
    ...
    public class TransientLifetimeTests: LifetimeTestsBase
    {
        [Test]
        [TestCase(typeof(int), typeof(string), "abc", typeof(string), typeof(long), typeof(DateTimeOffset), "xyz", typeof(DateTimeOffset), false)]
        [TestCase(typeof(int), typeof(string), "abc", typeof(string), typeof(int), typeof(string), "abc", typeof(string), false)]
        [TestCase(typeof(int), typeof(string), null, typeof(string), typeof(long), typeof(DateTimeOffset), null, typeof(DateTimeOffset), false)]
        [TestCase(typeof(int), typeof(string), null, typeof(string), typeof(int), typeof(string), null, typeof(string), false)]
        [TestCase(typeof(int), typeof(IList<>), "abc", typeof(IList<string>), typeof(int), typeof(IList<>), "abc", typeof(IList<DateTimeOffset>), false)]
        [TestCase(typeof(int), typeof(IList<>), "abc", typeof(IList<string>), typeof(int), typeof(IList<>), "abc", typeof(IList<string>), false)]
        ...
        [Test]
        public void ShouldNotDisposeWhenRelease()
        {
            // Given
            ...
            // Then
            ShouldDisposeWhenRelease(CreateTarget(), Times.Never());
        }
