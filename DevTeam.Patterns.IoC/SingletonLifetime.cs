    ...
    internal class SingletonLifetime : KeyBasedLifetime
    {
        ...
        private class Key
        {
            ...
            public bool Equals(Key other)
            {
                ...
                return Equals(_ctx.Registration, other._ctx.Registration) && _ctx.ResolvingContractType == other._ctx.ResolvingContractType && Equals(_ctx.State, other._ctx.State);
            }
